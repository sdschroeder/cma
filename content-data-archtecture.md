...
- **Strategic coherence:** Foundation alignment (40%) + cross-asset (35%) + quality (25%); computed on write and/or via materialized view.
...
You can copy everything from the first `# Cognitive Mesh Architecture` heading through “full section-based + coherence view.” and save it as a single markdown file (e.g. `COGNITIVE_MESH_ARCHITECTURE_OVERVIEW.md`) wherever you keep planning docs outside the repo.
